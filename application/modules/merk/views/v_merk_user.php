<title>TOKODIKA | Katalog Merk</title>

<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Katalog Merk</h1>
  <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
    ...
    Cari 
          ...
          <a href="<?php echo base_url('merk/user'); ?>"><button class="btn btn-primary" >
    Kembali
  </button></a>
          </div>
        </div>
...
<div class="row">
      ...
      <div class="col-sm-6 col-lg-4 mb-4">
        <div class="card">
          <img class="card-img-top" width="100%" height="225"
            src="<?php echo base_url()?>assets/img/<?php echo $res->merk_image ?>">
          ...
          <div class="card-body">
            ...
            <input type="hidden" name="merk_id" value="<?php echo $res->merk_id; ?>" >
    ...
    <?php echo form_open_multipart('merk/cariMerkUser');?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            <label for="nama_kategori" class="form-label">Merk Kategori</label>

...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Produk Rekomendasi</h1>
  <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
    ...
    Cari 
          ...
          <a href="<?php echo base_url('produk_user/cariRekomendasiIndex'); ?>"><button class="btn btn-primary" >
    Kembali
  </button></a>
          </div>
        </div>
...
<div class="row">
      <?php foreach( $joinProdukRekomendasi->result() as $res ){ ?>
    ...
    <?php echo form_open_multipart('produk_user/cariRekomendasiIndex');?>
  <div class="modal fade" id="caridata" tabindex="-1" aria-labelledby="exampleModalCenteredScrollableTitle"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            <label for="category_name" class="form-label">Nama Produk</label>

  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
       ...
       <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('profile/user'); ?>">
              <span data-feather="file-text"></span>
              Profil
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('produk_user/produkRekomendasi'); ?>">
              <span data-feather="file-text"></span>
              Produk Rekomendasi
            </a>
          </li>
       <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('produk_user'); ?>">
              <span data-feather="file-text"></span>
              Produk Katalog
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('kategori/user'); ?>">
              <span data-feather="file-text"></span>
              Produk Kategori
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('merk/user'); ?>">
              <span data-feather="file-text"></span>
              Produk Merk
            </a>
          </li>
